...
class Pegawai extends CI_Controller
{
  ...
  {
    $data['row'] = $this->pegawai_m->get($id);
  ...
  public function print_identitas($id)
  {
    $data['row'] = $this->pegawai_m->get($id);
    $html = $this->load->view('print/data_identitas', $data, true);
    $this->fungsi->PdfGenerator($html, 'Data_identitas_pegawai', 'A4', 'potrait');
  }
}
