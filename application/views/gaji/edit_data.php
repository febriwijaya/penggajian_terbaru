              ...
              <div class="col-md">
                <div class="card">
                  <div class="card-header text-center">
                    Form Edit Data Gaji Pegawai
                  </div>
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm- p-2">
                        <a class="btn btn-warning" href="<?= base_url('gaji') ?>"><i class="fas fa-undo-alt"></i> Back</a>
                      </div>
                    </div>
                      ...
                      <div class="col-sm">
                        <form action="" method="post">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="jabatan" id="jabatan" value="<?= $this->input->post('jabatan') ?? $row->jabatan ?>" placeholder="Jabatan....">
                            <?= form_error('jabatan', '<p class="text-danger">', '</p>'); ?>
                          </div>
                          <div class="form-group">
                            <label for="absensi">Jumlah Absensi</label>
                            <input type="text" class="form-control" name="absensi" id="absensi" value="<?= $this->input->post('absensi') ?? $row->absensi ?>" placeholder="Absensi....">
                            <?= form_error('absensi', '<p class="text-danger">', '</p>'); ?>
                          </div>
                          <div class="form-group">
                            <label for="gaji_pokok">Gaji Pokok</label>
                            <input type="text" class="form-control" name="gaji_pokok" id="gaji_pokok" value="<?= $this->input->post('gaji_pokok') ?? $row->gaji_pokok ?>" placeholder="Gaji Pokok....">
                            <?= form_error('gaji_pokok', '<p class="text-danger">', '</p>'); ?>
                          </div>
                          <div class="form-group">
                            <label for="tunjangan">Tunjangan</label>
                            <input type="text" class="form-control" name="tunjangan" id="tunjangan" value="<?= $this->input->post('tunjangan') ?? $row->tunjangan ?>" placeholder="Tunjangan....">
                            <?= form_error('tunjangan', '<p class="text-danger">', '</p>'); ?>
                          </div>
                          <div class="form-group">
                            <label for="bonus">Bonus</label>
                            <input type="text" class="form-control" name="bonus" id="bonus" value="<?= $this->input->post('bonus') ?? $row->bonus ?>" placeholder="Bonus....">
                            <?= form_error('bonus', '<p class="text-danger">', '</p>'); ?>
                          </div>
                          <div class="form-group">
                            <label for="lembur">Lembur</label>
                            <input type="text" class="form-control" name="lembur" id="lembur" value="<?= $this->input->post('lembur') ?? $row->lembur ?>" placeholder="Lembur....">
                            <?= form_error('lembur', '<p class="text-danger">', '</p>'); ?>
                          </div>
                          <div class="form-group">
                            <label for="bpjs1">Bpjs Ketenaga kerjaan</label>
                            <input type="text" class="form-control" name="bpjs1" id="bpjs1" value="<?= $this->input->post('bpjs1') ?? $row->bpjs1 ?>" placeholder="Bpjs ketenaga kerjaan....">
                            <?= form_error('bpjs1', '<p class="text-danger">', '</p>'); ?>
                          </div>
                          <div class="form-group">
                            <label for="bpjs2">Bpjs Keterangan kesehatan</label>
                            <input type="text" class="form-control" name="bpjs2" id="bpjs2" value="<?= $this->input->post('bpjs2') ?? $row->bpjs2 ?>" placeholder="Bpjs keterangan kesehatan....">
                            <?= form_error('bpjs2', '<p class="text-danger">', '</p>'); ?>
                          </div>
                          <div class="form-group">
                            <label for="listrik">Listrik</label>
                            <input type="text" class="form-control" name="listrik" id="listrik" value="<?= $this->input->post('listrik') ?? $row->listrik ?>" placeholder="Listrik....">
                            <?= form_error('listrik', '<p class="text-danger">', '</p>'); ?>
                          </div>
                          <div class="form-group">
                            <label for="asuransi">Asuransi</label>
                            <input type="text" class="form-control" name="asuransi" id="asuransi" value="<?= $this->input->post('asuransi') ?? $row->asuransi ?>" placeholder="Asuransi....">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="total_pendapatan" id="total_pendapatan" value="<?= $this->input->post('total_pendapatan') ?? $row->total_pendapatan ?>" placeholder="Total pendapatan....">
                            <?= form_error('total_pendapatan', '<p class="text-danger">', '</p>'); ?>
                          </div>
                          <div class="form-group">
                            <label for="total_potongan">Total potongan</label>
                            <input type="text" class="form-control" name="total_potongan" id="total_potongan" value="<?= $this->input->post('total_potongan') ?? $row->total_potongan ?>" placeholder="Total potongan....">
                            <?= form_error('total_potongan', '<p class="text-danger">', '</p>'); ?>
                          </div>
                          <div class="form-group">
                            <label for="gaji_bersih">Gaji Bersih</label>
                            <input type="text" class="form-control" name="gaji_bersih" id="gaji_bersih" value="<?= $this->input->post('gaji_bersih') ?? $row->gaji_bersih ?>" placeholder="Gaji Bersih....">
