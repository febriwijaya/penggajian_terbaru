...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Jul 2020 pada 06.56
...
CREATE TABLE `gaji` (
  ...
  `lembur` varchar(250) NOT NULL,
  `bpjs1` varchar(250) NOT NULL,
  `bpjs2` varchar(250) NOT NULL,
  `listrik` varchar(100) NOT NULL,
  `asuransi` varchar(250) NOT NULL,
  `total_pendapatan` varchar(250) NOT NULL,
  `total_potongan` varchar(250) NOT NULL,
...
INSERT INTO `gaji` (`id`, `nama`, `jabatan`, `absensi`, `gaji_pokok`, `tunjangan`, `bonus`, `lembur`, `bpjs1`, `bpjs2`, `listrik`, `asuransi`, `total_pendapatan`, `total_potongan`, `gaji_bersih`) VALUES
(4, 'rendi', 'manager', '2', '1000', '100', '100', '100', '100', '100', '100', '100', '1500', '200', '1300');
